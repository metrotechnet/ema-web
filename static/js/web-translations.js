...
const EMA_I18N = {
    fr: {
        ...
        "how.subtitle": "Un parcours en 4 étapes : découverte, entrevue, validation et partage.",
        ...
        "how.step1Title": "Étape 1 – Découvrez",
        "how.step1Point1": "Définissez l'expertise, l'expérience ou le processus que vous souhaitez documenter.",
        "how.step1Point2": "EMA pourra vous poser quelques questions afin de s'assurer qu'il comprend bien votre intention et le contexte.",
        "how.step1Point3": "Une fois votre objectif bien compris, EMA vous proposera un plan de travail pour structurer les différents sujets à explorer.",
        "how.step2Title": "Étape 2 – Interviewez",
        "how.step2Point1": "Répondez aux questions qu'EMA vous suggère en suivant le plan proposé.",
        "how.step2Point2": "Vous pouvez également y aller sans filet et discuter librement de votre sujet.",
        "how.step2Point3": "Durant la conversation, EMA prend des notes et organise les informations recueillies afin de les transformer en connaissances structurées.",
        "how.step2Point4": "Ajoutez des fichiers contenant des informations complémentaires. EMA les analysera et les intégrera aux connaissances recueillies.",
        "how.step2Point5": "Générez un résumé de votre conversation dans l'onglet Résumé, puis validez et, au besoin, corrigez les notes prises par EMA.",
        "how.step2Point6": "Une fois l'entrevue terminée, rendez-vous dans l'onglet Discussion pour interroger EMA et tester les connaissances qu'il a acquises.",
        "how.step3Title": "Étape 3 – Validez",
        "how.step3Point1": "Validez EMA sur les connaissances qu'il a acquises pendant l'entrevue.",
        "how.step3Point2": "Confirmez ce qui est juste, corrigez ce qui doit l'être et complétez les éléments manquants si nécessaire.",
        "how.step3Point3": "Cette étape permet de fiabiliser la synthèse avant de la partager.",
        "how.step4Title": "Étape 4 – Partagez",
        "how.step4Point1": "Partagez votre expertise avec des collègues ou d'autres personnes de votre choix.",
        "how.step4Point2": "Regroupez plusieurs expertises sous des thèmes et partagez également ces groupes.",
        "how.step4Point3": "Les personnes avec qui vous partagez votre expertise pourront interroger EMA afin d'en apprendre davantage sur le sujet.",
        "how.step4Point4": "Recommencez! Capturez une nouvelle expérience, documentez une autre expertise et partagez vos connaissances.",
        "faq.title": "FAQ",
    ...
    en: {
        ...
        "how.subtitle": "A 4-step journey: discover, interview, validate, and share.",
        ...
        "how.step1Title": "Step 1 - Discover",
        "how.step1Point1": "Define the expertise, experience, or process you want to document.",
        "how.step1Point2": "EMA may ask a few questions to make sure it understands your intent and the context.",
        "how.step1Point3": "Once your goal is clear, EMA will suggest a work plan to structure the different topics to explore.",
        "how.step2Title": "Step 2 - Interview",
        "how.step2Point1": "Answer the questions EMA suggests while following the proposed plan.",
        "how.step2Point2": "You can also go off-script and discuss your topic freely.",
        "how.step2Point3": "During the conversation, EMA takes notes and organizes the collected information into structured knowledge.",
        "how.step2Point4": "Add files with additional information. EMA will analyze them and integrate them into the collected knowledge.",
        "how.step2Point5": "Generate a summary of your conversation in the Summary tab, then validate and, if needed, correct the notes taken by EMA.",
        "how.step2Point6": "Once the interview is finished, go to the Discussion tab to question EMA and test the knowledge it has acquired.",
        "how.step3Title": "Step 3 - Validate",
        "how.step3Point1": "Validate EMA on the knowledge it acquired during the interview.",
        "how.step3Point2": "Confirm what is correct, fix what needs to be adjusted, and complete missing elements if needed.",
        "how.step3Point3": "This step helps make the summary reliable before sharing it.",
        "how.step4Title": "Step 4 - Share",
        "how.step4Point1": "Share your expertise with colleagues or other people of your choice.",
        "how.step4Point2": "Group multiple areas of expertise by theme and share those groups as well.",
        "how.step4Point3": "People you share your expertise with will be able to question EMA to learn more about the topic.",
        "how.step4Point4": "Repeat! Capture a new experience, document another expertise, and share your knowledge.",
        "faq.title": "FAQ",
    ...
    es: {
        ...
        "how.subtitle": "Un recorrido en 4 etapas: descubrir, entrevistar, validar y compartir.",
        ...
        "how.step1Title": "Paso 1 - Descubre",
        "how.step1Point1": "Define la experiencia, el conocimiento o el proceso que quieres documentar.",
        "how.step1Point2": "EMA puede hacerte algunas preguntas para asegurarse de entender bien tu intención y el contexto.",
        "how.step1Point3": "Cuando tu objetivo esté claro, EMA te propondrá un plan de trabajo para estructurar los distintos temas a explorar.",
        "how.step2Title": "Paso 2 - Entrevista",
        "how.step2Point1": "Responde a las preguntas que EMA te sugiera siguiendo el plan propuesto.",
        "how.step2Point2": "También puedes ir sin guion y hablar libremente sobre tu tema.",
        "how.step2Point3": "Durante la conversación, EMA toma notas y organiza la información recopilada para convertirla en conocimiento estructurado.",
        "how.step2Point4": "Agrega archivos con información adicional. EMA los analizará e integrará a los conocimientos recopilados.",
        "how.step2Point5": "Genera un resumen de tu conversación en la pestaña Resumen y luego valida y, si es necesario, corrige las notas tomadas por EMA.",
        "how.step2Point6": "Cuando termine la entrevista, ve a la pestaña Discusión para preguntar a EMA y probar el conocimiento que ha adquirido.",
        "how.step3Title": "Paso 3 - Valida",
        "how.step3Point1": "Valida con EMA el conocimiento que adquirió durante la entrevista.",
        "how.step3Point2": "Confirma lo que está correcto, corrige lo que deba ajustarse y completa los elementos faltantes si es necesario.",
        "how.step3Point3": "Este paso ayuda a que el resumen sea fiable antes de compartirlo.",
        "how.step4Title": "Paso 4 - Comparte",
        "how.step4Point1": "Comparte tu experiencia con colegas u otras personas de tu elección.",
        "how.step4Point2": "Agrupa varias áreas de experiencia por tema y comparte también esos grupos.",
        "how.step4Point3": "Las personas con las que compartas tu experiencia podrán consultar a EMA para aprender más sobre el tema.",
        "how.step4Point4": "¡Repite! Captura una nueva experiencia, documenta otra área de conocimiento y comparte tus conocimientos.",
        "faq.title": "FAQ",
