...
const DEMO_URL = "https://imx-ema-demo.web.app/";
...
const EMA_I18N = {
    fr: {
        ...
        "hero.eyebrow": "Enterprise Memory Agent",
...
function applyI18n(lang) {
    ...
    if (heroStartLink) {
        heroStartLink.setAttribute("href", DEMO_URL);
    }

    const usageStartLink = document.getElementById("usage-start-link");
    if (usageStartLink) {
        usageStartLink.setAttribute("href", DEMO_URL);
    }
